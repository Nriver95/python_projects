...
# Importing other modules so this file has access to them
...
def load_gui(self):
    ...
    #for label user
    self.lbl_user = tk.Label(self.master,text='Username:')
    ...
    #to define the listbox with a scrollbar and grid them
    ...
    #button for deleting information from database
